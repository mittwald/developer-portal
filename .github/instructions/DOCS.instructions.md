...
- Text should not have spelling or grammar mistakes and should be worded clearly, concisely and professionally, but not overly formal. Make suggestions for improvements during code review.
...
- Commands that should be run in a terminal must clearly indicate if they should be run in a local terminal, or in any kind of remote environment.
