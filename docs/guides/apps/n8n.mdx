...
flowchart TD
  ...
  subgraph "Mittwald Hosting (Container Stack)"
    N8N[n8n]
...
You can now test monitoring by placing documents in this directory. Delivery of the documents can happen in various ways (e.g., via
