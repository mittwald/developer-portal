...
While the underyling code is stable, the command interface and behavior may evolve
...
Updating the app can be fully automated with GitHub Actions, so you can focus on building and
improving your app while the deployment process runs in the background.
