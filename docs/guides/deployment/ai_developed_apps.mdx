...
### Migrating from Replit to mittwald {#migrating-replit-to-mittwald}

Replit ships exported apps in npm workspaces as monorepo Git repository.
...
### Migrating from Lovable to mittwald {#migrating-lovable-to-mittwald}

Apps created with Lovable can be exported to GitHub as a standard Node.js project.
...
[Lovable Git integration docs](https://docs.lovable.dev/integrations/github)
