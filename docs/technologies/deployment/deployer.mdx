...
<Tabs groupId="ci-solution">
  <TabItem value="github" label="GitHub Actions">
    ...
    First, configure the SSH host key as a secret for your repository. Using the [GitHub CLI][github-cli], you can do this with the following command (replace `[hostname]` with your actual SSH hostname):
  ...
  <TabItem value="gitlab" label="GitLab CI">
    ...
    First, configure the SSH host key as a secret for your repository. Using the [Gitlab CLI][gitlab-cli], you can do this with the following command (replace `[hostname]` with your actual SSH hostname):
