...
Configure the [mittwald MCP server](/docs/v2/agentic-coding/mcp/) in your AI assistant. The skills will call `mcp__mittwald__mittwald_*` tools directly.
...
**Setup:**
Follow the [MCP getting connected guide](/docs/v2/agentic-coding/mcp/getting-connected/) for your specific AI assistant.
...
- [Learn about MCP](/docs/v2/agentic-coding/mcp/) - Explore infrastructure management
