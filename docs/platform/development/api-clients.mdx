    ...
    steps:
      ...
      - name: Filter deprecated endpoints from OpenAPI spec
        run: |
          ...
          python filter_openapi_deprecated.py openapi.json openapi.json

      - name: Set dynamic version in OpenAPI spec
        run: |
          python adjust_openapi_version.py openapi.json openapi.json
      ...
      - name: Run Tests
        run: |
          # Replace with your test framework and cases, e.g. pytest tests/
          echo "Run your tests!"

      - name: Configure Poetry for TestPyPI (/legacy/)
        run: |
