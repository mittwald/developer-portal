...
Have a look at our collection of [deployment guides](/docs/v2/guides/deployment/) for more information on how to deploy your code.
...
## Enabling PHP auto-updates {#auto-updates}
