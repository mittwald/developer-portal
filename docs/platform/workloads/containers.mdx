...
## Making containers accessible from the internet

In order to make a container port accessible from the internet, you need to define an Ingress resource which maps to the given container.
