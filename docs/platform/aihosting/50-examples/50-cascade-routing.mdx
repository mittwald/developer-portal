...
See the model pages for parameter details: [Qwen3.5-0.8B](/docs/v2/platform/aihosting/models/qwen3-5-0-8b), [Qwen3.6-35B-A3B-FP8](/docs/v2/platform/aihosting/models/qwen3-6-35b-a3b-fp8), [Qwen3.5-122B-A10B-FP8](/docs/v2/platform/aihosting/models/qwen3-5-122b-a10b-fp8).

:::tip Thinking mode
`Qwen3.5-122B-A10B-FP8` has thinking mode enabled by default, which adds latency. For a cascade favoring fast turnaround, disable it via `extra_body={"chat_template_kwargs": {"enable_thinking": False}}` — see [Disabling thinking mode](/docs/v2/platform/aihosting/models/qwen3-5-122b-a10b-fp8#disable-thinking). Leave it enabled if tier-3 queries benefit from step-by-step reasoning.
:::
