...
You can furhter specify how Open Web UI interacts with the model. These settings are available to you in the user settings (not Administrator panel) under "Audio":
