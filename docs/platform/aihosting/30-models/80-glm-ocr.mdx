...
The model is provided by Z.ai under the [MIT License](https://opensource.org/licenses/MIT), and reuse of the extracted content is not subject to any additional restrictions imposed by the model license.
