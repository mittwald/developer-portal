...
### Office documents (DOCX, PPTX, XLSX) {#office-documents}
...
## Tips for specific tasks {#tips-for-specific-tasks}

### Large documents (> 30 pages) {#large-documents}
...
### Tables and structured data {#tables-and-structured-data}
...
### Key information extraction (KIE) {#key-information-extraction}
...
### Formula and mathematical expression recognition {#formula-and-mathematical-expression-recognition}
...
### Improving accuracy on low-quality scans {#improving-accuracy-on-low-quality-scans}
