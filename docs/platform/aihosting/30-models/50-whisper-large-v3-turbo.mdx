...
The model is provided by OpenAI under the [MIT License](https://opensource.org/licenses/MIT), and reuse of the generated content is subject to no additional restrictions.
