...
- `413 Request Entity Too Large`: The request was rejected before reaching the model. Two possible causes:
  - The document exceeds the **30-page limit** (GLM-OCR). Split it into batches of up to 30 pages per request.
  - The request body exceeds **200 MB**. Reduce the file size or split the document.
