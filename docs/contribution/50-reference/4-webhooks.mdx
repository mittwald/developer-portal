  ...
  schema={{
    ...
    properties: {
      ...
      variantKey: {
        type: "string",
        description:
          "Key of the variant that is currently chosen for the Extension Instance. This can be used to enable or disable features.",
        example: "default",
      },
      request: {
        type: "object",
  ...
  schema={{
    ...
    properties: {
      ...
      variantKey: {
        type: "string",
        description:
          "Key of the variant that is currently booked for the Extension Instance. This can be used to enable or disable features.",
        example: "default",
      },
      request: {
        type: "object",
