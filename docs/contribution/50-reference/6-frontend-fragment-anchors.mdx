...
| `/projects/project/container/containers/detail/menu-top/item` | Tab in a container's detail view   | `projectId`, `containerId`       |
| `/projects/project/backups/detail/menu-top/item`              | Tab in a backups's detail view     | `projectId`, `backupId`          |
