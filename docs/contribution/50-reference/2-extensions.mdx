...
Extensions can be created and managed in the `Entwicklung` section of the Contributor in the mStudio.
 
The following is a Schema of all properties of an extension:
    ...
    properties: {
      ...
      state: {
        ...
        properties: {
          enabled: {
            description:
              "//TODO Defines, whether this Extension is visible in the mStudio",
          },
          disabled: {
            description:
              "//TODO Defines, whether Instances of this Extension may exist",
          },
          blocked: {
            description:
              "//TODO Defines, whether this Extension may be added to a context",
          },
        },
      },
      disabled: {
