...
The use of access tokens is described in [authenticating API requests](../../../api/intro#authenticating-requests).

You can consult the operations in the [API reference](../../../reference/) to attain knowledge of whether you have to be authenticated to execute those routes.
