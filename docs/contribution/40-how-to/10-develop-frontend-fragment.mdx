...
For more details, see the [frontend fragment anchors reference](../../reference/frontend-fragment-anchors).
...
because [ready-to-use remote components](https://flow.mittwald.de/03-components/actions/action-group) for Flow are available.
...
You can find a full documentation of available components in the [Flow Repository](https://flow.mittwald.de).
...
The available context parameters are shown in mStudio while configuring the frontend fragment.
