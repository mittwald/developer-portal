...
Extensions can now be managed primarily through the **mStudio** interface, available in the Entwickeln tab for [registered contributors](../become-contributor).  
Here, you can create, edit, request verification, and publish your Extension — without needing to call the API directly.

Alternatively, all actions can still be performed via the mStudio's REST API.  
This remains useful for automation or integrating Extension management into CI/CD workflows.
...
Once your Extension has been verified, it can be published, you can publish your extension only via our REST API.
