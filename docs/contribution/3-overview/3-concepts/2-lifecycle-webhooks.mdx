...
The extension instance secret is rotated regularly for security resons.
...
You can't immediately use the new secrete in the webhook handler, analogously to the [ExtensionAddedToContext](#extensionaddedtocontext) webhook.
