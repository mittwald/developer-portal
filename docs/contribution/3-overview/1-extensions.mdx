...
Für weitere Informationen zum Templating siehe [Templating von Konfigurationswerten](../concepts/templating).
...
- `apiVersion` - API-Version des External Frontend URL Templates. Zu Beginn immer `v1`. Siehe auch [Versionierung von APIs](../concepts/api-versioning)
