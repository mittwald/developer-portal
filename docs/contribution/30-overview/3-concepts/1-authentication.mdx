...
The Session Token can be used within [frontend fragments](../frontend-development#frontend-fragments) to ensure authentication.
For more information visit the [session handling using session token](../frontend-development#authentication-and-session-handling-using-session-tokens) section.
...
For more information, see [Extension external frontend](../../extensions#frontend).
