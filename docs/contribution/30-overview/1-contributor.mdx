...
A Contributor is an organization that can develop and provide [Extensions](../extensions) for mStudio.
...
In order to publish Extensions, your organization must be verified as a Contributor.
...
To be listed as a Contributor in the mStudio Marketplace, your organization needs a logo.
By default, this will be inherited from your organization.
...
Your organization must provide valid support contact information.
