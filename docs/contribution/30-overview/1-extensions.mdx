...
Also the scopes, context and support contact information have to be set.
If your extension is not free the webhookUrls are also required.

The verification can be aborted by the contributor.

The extension will now be reviewed and verified by mittwald.
...
This prevents new ExtensionInstances from being created and disables already existing instances.
...
The extension is deleted asynchronously because all extension instances are deleted beforehand.
