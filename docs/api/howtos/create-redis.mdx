...
For more details please refer to the [endpoint documentation for `database-create-redis-database`](https://developer.mittwald.de/reference/v2#tag/Database/operation/database-create-redis-database).
...
For more details please refer to the [endpoint documentation for `database-get-redis-database`](https://developer.mittwald.de/reference/v2#tag/Database/operation/database-get-redis-database).
