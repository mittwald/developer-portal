...
To create a Redis database, you will need to have access to a project. You can find out how to create a project [here](./create-project). You will need the **project ID** for the subsequent operations.

## List available Redis versions

Set a `GET` request to the `/v2/redis-versions` endpoint to get a list of available Redis versions.
