...
This is part of the [Agentic Integration](/docs/v2/agentic-integration/) capabilities at mittwald. While [IDE Integration](/docs/v2/agentic-integration/ide-integration/) focuses on code generation, MCP enables infrastructure management through natural language.
...
## Agentic Integration: AI That Takes Action {#agentic-integration}
...
## MCP Ecosystem Servers {#mcp-ecosystem-servers}
...
For a comprehensive list of available MCP servers, see the [MCP Server Registry](https://github.com/modelcontextprotocol/servers).

## Related Documentation

Explore other agentic integration capabilities:

- **[IDE Integration](/docs/v2/agentic-integration/ide-integration/)** — Use mittwald AI models for code generation
- **[Agent Skills](/docs/v2/agentic-integration/agent-skills/)** — Pre-built workflows for migrations and deployments
