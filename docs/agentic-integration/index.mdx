...
## Four Ways to Use Agentic Integration at mittwald
...
Run a coding agent in your terminal against the same [GDPR-compliant AI models](/docs/v2/platform/aihosting). The agent reads and writes files, runs commands, and calls tools on its own — your code and prompts stay on infrastructure in Germany.

**Best for:** Multi-file changes, repo-wide refactoring, scripted and headless workflows
...
[Learn more about CLI Agents →](./cli-agents/)
...
1. Get your AI Hosting API key ([how to get one](/docs/v2/platform/aihosting/access-and-usage/access))
...
1. Get your AI Hosting API key ([how to get one](/docs/v2/platform/aihosting/access-and-usage/access))
2. Install one of the [supported agents](./cli-agents/)
3. Point it at endpoint: `https://llm.aihosting.mittwald.de/v1`
4. Verify tool calling works before relying on the agent — each guide has a check for this
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      label: "CLI Agents",
      href: "./cli-agents/",
      description: "Run terminal coding agents against mittwald AI Hosting",
    },
    {
      type: "link",
      label: "MCP Integration",
      href: "./mcp/",
      description: "Manage infrastructure through AI assistants",
    },
    {
      type: "link",
      label: "Agent Skills",
      href: "./agent-skills/",
      description: "Pre-built workflows for migrations and deployments",
    },
  ]}
/>
