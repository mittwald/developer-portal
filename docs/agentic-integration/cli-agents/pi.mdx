...
agent packs — and correspondingly more prompt overhead on its first request. On disk,
Pi installs to about 142 MB and opencode to about 160 MB, a modest difference either
way.
