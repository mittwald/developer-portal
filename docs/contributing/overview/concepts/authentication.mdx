...
Für eine Beschreibung, wie das erhaltene Access Token verwendet werden kann, siehe [API Referenz](../../../reference/api#nutzung-von-access-tokens-zur-authentifizierung).
