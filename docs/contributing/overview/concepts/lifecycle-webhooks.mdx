...
In diesem Event wird der externen Anwendung erstmalig die `Extension Instance ID` und das `Extension Instance Secret` mitgeteilt.
Diese können nachfolgend verwendet werden, um sich gegenüber mittwald zu authentifizieren.
