...
#### Externe Frontends (Name: WIP)

Eine Externe Anwendung kann einen oder mehrere Einstiegspunkte anbieten. Diese können dazu genutzt werden, um vom mStudio in die Externe Anwendung zu navigieren. Dabei bieten wir die Möglichkeit die Externe Anwendung per Single Sign On gegen die mittwald API zu authentifizieren.

Um Externe Frontends nutzen zu können, müssen die benötigten URL-Templates beim Anlegen der Extension definiert werden.

Benutze gerne [Flow, das mittwald Design System](https://mittwald.github.io/flow), um das Frontend deiner Extension zu bauen.