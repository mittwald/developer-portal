...
:::warning
Die `.env`-Datei solltest du nicht ins Versionskontrollsystem aufnehmen; füge sie zu `.gitignore` hinzu.
:::
...
Du kannst die rohe OpenAPI-Spezifikation direkt nutzen, um einen API-Client zu erstellen.
Oft ist es jedoch sinnvoll, die Spezifikation vorher anzupassen,
um den Client individueller zu gestalten.
...
[JSONPath](https://www.rfc-editor.org/rfc/rfc9535.pdf)-Selektoren für das `target`-Feld in den Aktionen zu bestimmen.
