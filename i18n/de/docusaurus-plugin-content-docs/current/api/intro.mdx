...
Änderungen an der API sind im [Changelog](/changelog/tags/apiv2/) dokumentiert. Changelog-Einträge werden automatisch am Ende eines jeden Tages generiert. Wenn du über Änderungen an der API informiert werden möchtest, kannst du den [RSS-Feed](/changelog/rss.xml) abonnieren.
