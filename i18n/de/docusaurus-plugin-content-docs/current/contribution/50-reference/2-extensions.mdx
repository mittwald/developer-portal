      ...
      statistics: {
        ...
        properties: {
          amountOfInstances: {
            ...
            description: "Die Anzahl an Extension Instances dieser Extension. Für den Contributor genau, öffentlich wird der Wert auf den nächst kleineren Hunderter gerundet."
        }
      },
      pricing: {
         oneOf: [
         {
          ...
          properties: {
            netPrice: {
              type: "integer",
              description: "Der Nettopreis der Extension in Euro Cent pro Monat.",
              example: 100
            }
          }
         }
