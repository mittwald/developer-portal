  ...
  schema={{
    ...
    properties: {
      id: {
        ...
        format: "uuid",
        description:
          "Global eindeutig identifizierender Bezeichner der Extension",
      },
      contributorId: {
        type: "string",
        format: "uuid",
      ...
      pricingDetails: {
        ...
        required: ["isUpgradeAllowed", "isDowngradeAllowed"],
        properties: {
          isUpgradeAllowed: {
            type: "boolean",
            description:
      ...
      requestedChanges: {
        type: "object",
        description:
          "Erlaubte Änderungen, die ein Contributor vorschlagen kann",
        properties: {
          context: {
            type: "object",
            properties: {
