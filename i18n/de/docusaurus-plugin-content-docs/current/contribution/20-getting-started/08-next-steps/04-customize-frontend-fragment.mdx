...
Weitere Informationen findest du im [Frontend Development Konzept](../../../overview/concepts/frontend-development).
...
- **Dokumentation**: [flow.mittwald.de](https://flow.mittwald.de/)
...
Unter [UI Patterns](https://flow.mittwald.de/03-patterns/anlegeprozess) und den folgenden Seiten sind gängige UX-Patterns beschrieben,
...
In der [flow-Dokumentation](https://flow.mittwald.de/) sind für alle Komponenten Dokumentation, Beispiele und Guidelines formuliert.
...
Falls die flow Components nicht für deinen Anwendungsfall geeignet sind, besteht auch die Möglichkeit, ein [externes Frontend](./05-external-frontend.mdx) zu entwickeln.
...
In unserem [Frontend Fragment Guide](../../../how-to/develop-frontend-fragment/#getconfig--useconfig-react) haben wir ausführlicher beschrieben,
