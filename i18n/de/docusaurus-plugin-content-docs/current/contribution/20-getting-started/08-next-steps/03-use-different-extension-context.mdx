...
:::info Extension Context nach dem Anfragen der Verifizierung nicht mehr änderbar
...
Wenn du also den Context deiner DEV-Umgebung änderst, denk vorher daran, den Tunnel wie im [Guide „Extension erreichbar machen“](../../expose-extension) beschrieben, zu starten.
...
Du musst maximal 10 Minuten auf den Retry warten.
:::

Deine Extension Instances werden nun gelöscht und danach wird der Context deiner Extension geändert.
Sobald du sehen kannst, dass deine Extension Instances entfernt wurden, kannst du eine neue erstellen.
