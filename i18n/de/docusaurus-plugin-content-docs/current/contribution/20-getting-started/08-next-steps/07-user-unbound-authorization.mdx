...
Detaillierte Informationen zum Beziehen eines Access-Tokens und dessen Einschränkungen findest du unter [Authentifizierung mit dem Extension Instance Secret](../../50-reference/5-api.mdx).
