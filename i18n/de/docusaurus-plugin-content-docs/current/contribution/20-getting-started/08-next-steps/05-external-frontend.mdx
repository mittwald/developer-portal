...
[OAuth2](https://datatracker.ietf.org/doc/html/rfc6749) ist ein gut dokumentierter Standard, für den viele Client Libraries existieren, unter anderem [`oidc-client-ts`](https://github.com/authts/oidc-client-ts), das neben OIDC auch OAuth2 unterstützt.
...
den wir entwickelt haben, um ohne Redirects, also ohne schnell wechselnde Seiten, direkt in einem externen Frontend authentifiziert zu sein.
...
Als Nächstes implementieren wir eine Server Function, die die benötigten Parameter entgegennimmt,
