...
Weitere Informationen zum Lebenszyklus von Extensions sind im [Extension Konzept](../../overview/extensions) erklärt.
:::
...
Dieses Secret kann wie der Extension Context und die Scopes im **Tab "Berechtigungen"** generiert werden.
...
sondern erst nach 24 Stunden invalidiert.
Das neue Secret muss also innerhalb von 24 Stunden in der Extension hinterlegt werden,
