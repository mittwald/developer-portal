...
Da der Marktplatz verschiedene Arten von Extensions zulässt, behandelt dieser Guide exemplarisch eine Extension mit Integration eines [Frontend Fragments](../overview/concepts/frontend-development) im mStudio. Andere Vorgehensweisen werden nicht vollständig beschrieben.
...
Dafür kommen unter anderem folgende in Frage:
...
Extensions werden immer im Kontext einer Organisation entwickelt und bereitgestellt, um Nutzerinnen und Nutzern anzeigen zu können,
...
7. [Nächste Schritte](./next-steps/introduction) – Die Reference Extension an deine eigenen Bedürfnisse und Ideen anpassen
