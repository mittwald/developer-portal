...
Nach dem Dry Run wird das Ergebnis der webhook execution in der [APIResponse](https://api.mittwald.de/v2/docs/#/Marketplace/extension-dry-run-webhook) zurück gegeben.
...
Die Demo-Werte können als Testdaten genutzt werden, um die interne Logik der Extension zu testen.\
