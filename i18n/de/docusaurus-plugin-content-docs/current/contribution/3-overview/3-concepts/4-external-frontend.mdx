...
- `accessTokenRetrievalKey` - Der AccessTokenRetrievalKey, auch genannt ATReK, des Users. Hiermit kann die Extension Instance eine [Authentifizierung via ATReK](../authentication#access-token-retrieval-key) durchführen
