...
Mehr Informationen sind in der Sektion [Sitzungsverwaltung mit Session-Token](../frontend-development#authentication-and-session-handling-using-session-tokens) zu finden.
