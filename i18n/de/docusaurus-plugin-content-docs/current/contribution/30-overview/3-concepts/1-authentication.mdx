...
Das Session Token kann innerhalb von [Frontend Fragmenten] benutzt werden um die Authentifizierung sicher zu stellen.
Mehr Informationen sind in der Sektion [Sitzungsverwaltung mit Session-Token](../frontend-development#authentifizierung-und-sitzungsverwaltung-mit-session-tokens) zu finden.
...
Für weitere Informationen darüber, wie ein ATReK gegen ein Access Token ausgetauscht wird, siehe [Access Token Retrieval Key Referenz](../../../reference/api#using-an-access-token-retrieval-key)
