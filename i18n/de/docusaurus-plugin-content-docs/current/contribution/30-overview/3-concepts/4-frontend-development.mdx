...
Die Konfiguration von Frontend Fragmenten dient dazu, Frontends einer Extension direkt in vordefinierte [Anchor](#anchor) innerhalb des mStudio zu integrieren.
...
## Authentifizierung und Sitzungsverwaltung mit Session-Tokens {#authentication-and-session-handling-using-session-tokens}
