...
Webhooks sind für die Grundfunktion einer Extension optional. Sie werden nur dann benötigt, wenn der Zustand (State) außerhalb des mStudios gespeichert werden soll.
