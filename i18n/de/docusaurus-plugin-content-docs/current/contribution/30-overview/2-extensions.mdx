...
Jeder Schritt wird entweder durch den Contributor oder durch mittwald durchgeführt, der Contributor kann seine Extension in seinem Entwickeln Tab bearbeiten sowie Verifizierung von Mittwald anfragen. Alternativ kann jeder Schritt auch über API-Operationen ausgeführt werden, wie in der [Dokumentation zur Extensionverwaltung](../../how-to/manage-extensions) erläutert.
...
Nach Freigabe bleibt die Extension für bestehende Nutzer:innen weiter nutzbar, neue Scopes müssen jedoch bestätigt werden.
