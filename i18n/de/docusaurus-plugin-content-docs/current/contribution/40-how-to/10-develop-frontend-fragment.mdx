...
Weitere Details findest du in der [Referenz zu Anchorn für Frontend-Fragmente](../../reference/frontend-fragment-anchors).

## Frontend entwickeln

Um ein Frontend-Fragment zu entwickeln, musst du Flow Remote Elemente verwenden.
Derzeit wird empfohlen, dein Frontend mit **React** zu bauen, da [einsatzbereite Remote Components](https://flow.mittwald.de/03-components/actions/action-group) für Flow verfügbar sind.
...
Eine vollständige Dokumentation der verfügbaren Komponenten findest du im [Flow Repository](https://flow.mittwald.de).
...
- [Flow Components](https://flow.mittwald.de)
- `<ul>`
- `<ol>`
- `<li>`
- `<strong>`
...
Die verfügbaren Kontextparameter werden im mStudio angezeigt, wenn du das Frontend-Fragment konfigurierst.
