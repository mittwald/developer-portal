...
Im Namen eines mStudio Benutzers bedeutet, dass zur Authentifizierung entweder das [Session-Token](../../overview/concepts/frontend-development#authentifizierung-und-sitzungsverwaltung-mit-session-tokens), der
