...
Im Namen eines mStudio Benutzers bedeutet, dass zur Authentifizierung entweder das [Session-Token](../../overview/concepts/frontend-development#authentication-and-session-handling-using-session-tokens), der
