...
```shellsession
user@local $ composer create-project shopware/production <folder>
...
```shellsession
user@local $ composer require shopware/docker
```
...
```shellsession
user@local $ docker compose exec app bin/console database:migrate --all
user@local $ docker compose exec app bin/console dal:refresh:index
user@local $ docker compose exec app bin/console cache:clear
user@local $ docker compose exec app bin/console plugin:refresh
```
