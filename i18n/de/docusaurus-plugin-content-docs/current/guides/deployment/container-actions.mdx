...
:::info Perfekt für mit KI entwickelte Apps

Die `zerodeploy-action` ist **ideal für mit KI entwickelte Anwendungen**, die von Plattformen wie Replit, Lovable oder Cursor exportiert wurden. Siehe unseren dedizierten Guide zum [Deployment von mit KI entwickelten Apps](/docs/v2/guides/deployment/ai_developed_apps/) für plattformspezifische Migrationstipps und Best Practices.
...
Diese Action ist besonders gut geeignet für Apps, die mit KI-Entwicklungswerkzeugen erstellt wurden. Für detaillierte Anleitungen zum Deployment von spezifischen Plattformen wie Replit oder Lovable siehe [Deployment von mit KI entwickelten Apps](/docs/v2/guides/deployment/ai_developed_apps/).
...
- **[Deployment von mit KI entwickelten Apps](/docs/v2/guides/deployment/ai_developed_apps/)** — Zero-Configuration-Deployment für Apps von Replit, Lovable und anderen KI-Entwicklungsplattformen
- **[Application Deployment mit deployer](/docs/v2/guides/deployment/deployer/)** — Alternativer Deployment-Ansatz mit Deployer
- **[Container](/docs/v2/platform/workloads/containers/)** — Container-Konzepte, Stack-Dateien und Registry-Setup verstehen
