...
Erstelle eine Datei `AdditionalConfiguration.php` im Ordner `typo3conf` und füge Folgendes ein. Sollte die Datei bereits existieren, kannst du `<?php` weglassen.
