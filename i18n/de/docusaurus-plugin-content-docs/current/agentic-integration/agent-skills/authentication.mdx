...
**Vorteile:**
- Gut für Skripte und Automatisierung
- Kein zusätzliches Tooling erforderlich
...
| CI/CD-Pipelines | **HTTP API** | Einfach, ohne zusätzliche Abhängigkeiten |
...
3. Für HTTP API: `echo $MITTWALD_API_TOKEN` gibt einen Wert aus
4. Für MCP: Verbindung im Tool ist aktiv
