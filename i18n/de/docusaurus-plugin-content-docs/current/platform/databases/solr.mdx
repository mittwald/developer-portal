...
2. Kopiere die Konfigurationsdateien in den Solr-Container:

   ```bash
   # Kopiere Hauptkonfigurationsdateien
   mw container cp -r /tmp/ext-solr/Resources/Private/Solr/configsets/ext_solr_13_0_0/conf <CONTAINER-ID>:/var/solr/data/typo3/
...
3. Kopiere die JAR-Datei für das TYPO3-Solr-Plugin:
