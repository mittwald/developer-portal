...
<Tabs groupId="access-mode">
  ...
  <TabItem value="cli" label="CLI">
    Die Verwaltung von Containern über die CLI wird derzeit nicht unterstützt. Bitte stimme für die entsprechende [Feature-Anfrage](https://github.com/mittwald/cli/issues/1150) ab.
  </TabItem>
...
<Tabs groupId="access-mode">
  ...
  <TabItem value="cli" label="CLI">
    Die Verwaltung von Container-Registries über die CLI wird derzeit nicht unterstützt. Bitte stimme für die entsprechende [Feature-Anfrage](https://github.com/mittwald/cli/issues/1150) ab.
  </TabItem>
  <TabItem value="terraform" label="Terraform">
