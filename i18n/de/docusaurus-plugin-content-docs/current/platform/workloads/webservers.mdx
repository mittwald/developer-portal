...
- ReactPHP-Anwendungen

## Voraussetzungen

Als Voraussetzung benötigst du eine mStudio-Anwendung, die einen Webserver enthält, z. B. eine [Node.js](../nodejs)- oder [Python](../python)-Anwendung. Die Anwendung muss einen "Einstiegspunkt" haben, der deinen Webserver startet.
