...
Unterstützte Formate, Limits und Inferenzparameter stehen in der [GLM-OCR Modellreferenz](/docs/v2/platform/aihosting/models/glm-ocr).
:::
...
GLM-OCR hat drei Ausgabemodi, alle über den Prompt gesteuert:
