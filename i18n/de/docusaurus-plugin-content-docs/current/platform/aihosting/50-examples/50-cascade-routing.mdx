...
| 3 — Frontier | `Qwen3.5-122B-A10B-FP8` | Komplexe Analysen, lange Dokumente, Vision |

Für Stufe 3 kann je nach Workload ein beliebiges großes Modell eingesetzt werden:

| Alternative für Stufe 3 | Stärken |
| ----------------------- | ------- |
| `Qwen3.5-122B-A10B-FP8` | Thinking-Modus, Vision, starkes Coding, 245k Context |
| `gpt-oss-120b` | Textbasiertes Reasoning, 131k Context |

Die Modellseiten für Parameterdetails: [Qwen3.5-0.8B](/docs/v2/platform/aihosting/models/qwen3-5-0-8b), [Qwen3.6-35B-A3B-FP8](/docs/v2/platform/aihosting/models/qwen3-6-35b-a3b-fp8), [Qwen3.5-122B-A10B-FP8](/docs/v2/platform/aihosting/models/qwen3-5-122b-a10b-fp8).

:::tip Thinking-Modus
`Qwen3.5-122B-A10B-FP8` hat standardmäßig den Thinking-Modus aktiviert, was Latenz hinzufügt. Für eine auf schnelle Antworten ausgelegte Kaskade diesen über `extra_body={"chat_template_kwargs": {"enable_thinking": False}}` deaktivieren — siehe [Thinking-Modus deaktivieren](/docs/v2/platform/aihosting/models/qwen3-5-122b-a10b-fp8#thinking-modus-deaktivieren). Aktiviert lassen, wenn Anfragen der Stufe 3 von schrittweisem Reasoning profitieren.
:::
...
| -------- | ----------------- |
| Alle Anfragen → Qwen3.5-122B-A10B-FP8 | ~30 € |
