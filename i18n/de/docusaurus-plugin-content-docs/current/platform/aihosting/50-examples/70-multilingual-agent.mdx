...
description: Einen Tool-Calling-Agenten bauen, der mit Qwen3.5-122B-A10B-FP8 über 100 Sprachen unterstützt
title: Mehrsprachiger Tool-Calling-Agent
---

Das Tool-Calling-Agenten-Muster in diesem Guide funktioniert mit jedem Chat-Modell, das Funktionsaufrufe unterstützt. Das Beispiel verwendet [Qwen3.5-122B-A10B-FP8](/docs/v2/platform/aihosting/models/qwen3-5-122b-a10b-fp8), aber es kann je nach Kosten- und Qualitätsanforderungen ein beliebiges der folgenden Modelle eingesetzt werden:
...
def run_agent(user_message: str, system: str | None = None) -> str:
    ...
    while True:
        response = client.chat.completions.create(
            ...
            # Thinking-Modus ist bei diesem Modell standardmäßig aktiv — hier deaktivieren,
            # um die Tool-Call-Latenz in der Agenten-Schleife niedrig zu halten.
        )
