...
Das Modell wird von OpenAI unter der [MIT-Lizenz](https://opensource.org/licenses/MIT) bereitgestellt, und die Wiederverwendung des generierten Inhalts unterliegt keinen zusätzlichen Einschränkungen.
