...
Wir bieten aktuell die nachfolgenden Modelle an, die sich im Laufe der Zeit ändern oder erweitern können. Zu jedem Modell findest du eine Beschreibung und die modellspezifischen Parameter.
...
- Für mehrstufige Coding-Aufgaben, Tool-Loops und länger laufende Agenten, bei denen eine dichte Architektur und eine wählbare Reasoning-Tiefe den Unterschied machen \
  verwende `Qwen3.8-27B-NVFP4`.
- Spezialanwendungen
