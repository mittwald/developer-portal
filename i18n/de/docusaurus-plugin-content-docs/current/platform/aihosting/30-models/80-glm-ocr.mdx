...
Das Modell wird von Z.ai unter der [MIT-Lizenz](https://opensource.org/licenses/MIT) angeboten. Die Weiternutzung der extrahierten Inhalte unterliegt keinen zusätzlichen Einschränkungen durch die Modelllizenz.
