...
Diese Modelle unterstützen Standard-Textgenerierung, JSON-Ausgabeformatierung, Tool Calling und Streaming-Antworten. Die Ministral- und Qwen-Modelle unterstützen zusätzlich Bildverarbeitungsfunktionen zur Analyse und Beschreibung von Bildern.
