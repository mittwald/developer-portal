...
- `413 Request Entity Too Large`: Die Anfrage wurde abgewiesen, bevor sie das Modell erreicht hat. Zwei mögliche Ursachen:
  - Das Dokument überschreitet das **30-Seiten-Limit** (GLM-OCR). Das Dokument in Batches von maximal 30 Seiten pro Anfrage aufteilen.
  - Der Anfrage-Body überschreitet **200 MB**. Dateigröße reduzieren oder das Dokument aufteilen.
