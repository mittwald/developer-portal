...
:::caution
Ein Bild an ein Modell ohne Vision-Support zu senden, führt auf keinem der beiden Endpunkte zu einem Fehler. Bilder nur an Modelle senden, die als vision-fähig dokumentiert sind (Ministral-3-14B-Instruct-2512, Qwen3.5-122B-A10B-FP8, Qwen3.6-35B-A3B-FP8, GLM-OCR).
:::
