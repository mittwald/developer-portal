...
:::info Umfang der Provisionierung
Dedicated AI Hosting richten wir gemeinsam mit dir im Onboarding ein. Eine Self-Service-Provisionierung über mStudio gibt es derzeit nicht.
:::
...
const response = await client.chat.completions.create({
  ...
  messages: [
    {
      role: "user",
      content: "Erkläre Retrieval-Augmented Generation in zwei Sätzen.",
    },
  ],
});
