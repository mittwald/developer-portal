---
title: API changes for v2 API, February 6 to February 13
authors:
  - machine
tags:
  - apiv2
...
This document contains changes that can under certain circumstances be considered breaking regarding an error responses of the `users` resource.

However, we have only adjusted the type to match the actual response.
