...
- The request body type for the `POST` operation at the path `/v2/actions/list-ingresses-compatible-with-certificate` has changed from 'object' to an empty format. This is a breaking change.
...
- Several response properties have become optional for the status '200' in the `GET` operation at the path `/v2/certificates`: 
  - `/items/certificate`
  - `/items/isExpired`
  - `/items/lastExpirationThresholdHit`
  - `/items/validFrom`
  - `/items/validTo`
- The response property `certificate` has become optional for the status '200' in the `GET` operation at the path `/v2/certificates/{certificateId}`.
- The response property `isExpired` has become optional for the status '200' in the `GET` operation at the path `/v2/certificates/{certificateId}`.
- The response property `lastExpirationThresholdHit` has become optional for the status '200' in the `GET` operation at the path `/v2/certificates/{certificateId}`.
- The response property `validFrom` has become optional for the status '200' in the `GET` operation at the path `/v2/certificates/{certificateId}`.
- The response property `validTo` has become optional for the status '200' in the `GET` operation at the path `/v2/certificates/{certificateId}`.
- A default value of '10000.00' has been added for the `query` request parameter `limit` in the `GET` operation at the path `/v2/domains`.
- The request property `certificate` has been removed from the `POST` operation at the path `/v2/actions/list-ingresses-compatible-with-certificate`.
- The request property `projectId` has been removed from the `POST` operation at the path `/v2/actions/list-ingresses-compatible-with-certificate`.
- A new enum value '3.00' has been added to the `/items/certificateType` response property for the status '200' in the `GET` operation at the path `/v2/certificate-requests`.
- A new enum value '3.00' has been added to the `certificateType` response property for the status '200' in the `GET` operation at the path `/v2/certificate-requests/{certificateRequestId}`.
- A new enum value '3.00' has been added to the `/items/certificateType` response property for the status '200' in the `GET` operation at the path `/v2/certificates`.
- A new enum value '3.00' has been added to the `certificateType` response property for the status '200' in the `GET` operation at the path `/v2/certificates/{certificateId}`.
...
- The request body has been updated to include `#/components/schemas/de.mittwald.v1.ingress.ListIngressesCompatibleWithCertificateRequest` and `#/components/schemas/de.mittwald.v1.ingress.ListIngressesCompatibleWithCertificateIDRequest` in the `oneOf` list for the `POST` operation at the path `/v2/actions/list-ingresses-compatible-with-certificate`.
- The request body has been updated to include `#/components/schemas/de.mittwald.v1.ssl.CertificateRequestCreateWithDNSRequest` in the `oneOf` list for the `POST` operation at the path `/v2/certificate-requests`.
- A non-success response with the status '409' has been added for the `POST` operation at the path `/v2/certificate-requests`.
- A non-success response with the status '412' has been added for the `POST` operation at the path `/v2/certificate-requests`.
- The optional property `/items/dnsCertSpec` has been added to the response with the '200' status in the `GET` operation at the path `/v2/certificates`.
- The optional property `dnsCertSpec` has been added to the response with the '200' status in the `GET` operation at the path `/v2/certificates/{certificateId}`.
...
- ⚠️ **Breaking:** the request's body type/format changed from 'object'/'' to ''/''

- removed the request property 'certificate'

- removed the request property 'projectId'

- added '#/components/schemas/de.mittwald.v1.ingress.ListIngressesCompatibleWithCertificateRequest, #/components/schemas/de.mittwald.v1.ingress.ListIngressesCompatibleWithCertificateIDRequest' to the request body 'oneOf' list
...
- ⚠️ **Breaking:** the response property 'contact' became optional for the status '201'
...
- ⚠️ **Breaking:** the response property '/items/certificate' became optional for the status '200'

- ⚠️ **Breaking:** the response property '/items/isExpired' became optional for the status '200'

- ⚠️ **Breaking:** the response property '/items/lastExpirationThresholdHit' became optional for the status '200'

- ⚠️ **Breaking:** the response property '/items/validFrom' became optional for the status '200'

- ⚠️ **Breaking:** the response property '/items/validTo' became optional for the status '200'

- added the new '3.00' enum value to the '/items/certificateType' response property for the response status '200'

- added the optional property '/items/dnsCertSpec' to the response with the '200' status
...
- ⚠️ **Breaking:** the response property 'certificate' became optional for the status '200'

- ⚠️ **Breaking:** the response property 'isExpired' became optional for the status '200'

- ⚠️ **Breaking:** the response property 'lastExpirationThresholdHit' became optional for the status '200'

- ⚠️ **Breaking:** the response property 'validFrom' became optional for the status '200'

- ⚠️ **Breaking:** the response property 'validTo' became optional for the status '200'

- added the new '3.00' enum value to the 'certificateType' response property for the response status '200'

- added the optional property 'dnsCertSpec' to the response with the '200' status
