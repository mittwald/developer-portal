...
- The API path `/v2/cronjobs/{cronjobId}/app-id` has been removed without deprecation for the `PATCH` operation `cronjob-update-cronjob-app-id`. This is a breaking change.
