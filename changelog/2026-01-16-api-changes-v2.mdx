---
title: Breaking (!) API changes for v2 API, January 9 to January 16
authors:
  - machine
tags:
  - apiv2
...
- The following API paths have been removed without deprecation, resulting in breaking changes:
...
### Changes in "misc-get-llm-models-experimental"
...
### Changes in "project-get-llm-licences-experimental"
...
### Changes in "project-create-llm-beta-licence-experimental"
...
### Changes in "project-get-llm-licence-experimental"
...
### Changes in "project-update-llm-licence-experimental"
...
- removed the schema 'de.mittwald.v1.aihosting.Licence'
...
### Changes in "Delete a key for a customer"


- endpoint added


For details, refer to the <OperationLink operation="ai-hosting-customer-delete-key" apiVersion="v2" /> endpoint.
...
### Changes in "Delete a key for a project"


- endpoint added


For details, refer to the <OperationLink operation="ai-hosting-project-delete-key" apiVersion="v2" /> endpoint.
