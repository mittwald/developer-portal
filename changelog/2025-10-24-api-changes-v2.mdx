---
title: Breaking (!) API changes for v2 API, October 17 to October 24
authors:
  - machine
tags:
  - apiv2
...
- The type/format of the 'appInstallationId' request parameter has changed from 'string'/'uuid' to 'string' for the following operations: 
  - DELETE /v2/app-installations/{appInstallationId} (app-uninstall-appinstallation)
  - GET /v2/app-installations/{appInstallationId} (app-get-appinstallation)
  - PATCH /v2/app-installations/{appInstallationId} (app-patch-appinstallation)
  - PATCH /v2/app-installations/{appInstallationId}/database (app-link-database)
  - PATCH /v2/app-installations/{appInstallationId}/database/replace (app-replace-database)
  - DELETE /v2/app-installations/{appInstallationId}/databases/{databaseId} (app-unlink-database)
  - PUT /v2/app-installations/{appInstallationId}/databases/{databaseId}/users (app-set-database-users)
  - GET /v2/app-installations/{appInstallationId}/missing-dependencies (app-get-missing-dependencies-for-appinstallation)
  - GET /v2/app-installations/{appInstallationId}/systemSoftware (app-get-installed-systemsoftware-for-appinstallation)  
  **Note: This is a breaking change.**

- The type/format of the 'cronjobId' request parameter has changed from 'string'/'uuid' to 'string' for the following operations:
  - DELETE /v2/cronjobs/{cronjobId} (cronjob-delete-cronjob)
  - GET /v2/cronjobs/{cronjobId} (cronjob-get-cronjob)
  - PATCH /v2/cronjobs/{cronjobId} (cronjob-update-cronjob)
  - PATCH /v2/cronjobs/{cronjobId}/app-id (cronjob-update-cronjob-app-id)
  - GET /v2/cronjobs/{cronjobId}/executions (cronjob-list-executions)
  - POST /v2/cronjobs/{cronjobId}/executions (cronjob-create-execution)
  - GET /v2/cronjobs/{cronjobId}/executions/{executionId} (cronjob-get-execution)
  - POST /v2/cronjobs/{cronjobId}/executions/{executionId}/actions/abort (cronjob-abort-execution)  
  **Note: This is a breaking change.**

- The type/format of the 'customerId' request parameter has changed from 'string'/'uuid' to 'string' for the following operations:
  - POST /v2/customers/{customerId}/actions/leave (deprecated-customer-leave-customer)
  - POST /v2/customers/{customerId}/invites (customer-create-customer-invite)  
  **Note: This is a breaking change.**

- The type/format of the 'fileId' request parameter has changed from 'string'/'uuid' to 'string' for the following operations:
  - GET /v2/files/{fileId} (file-get-file)
  - GET /v2/files/{fileId}/meta (file-get-file-meta)
  - GET /v2/files/{fileId}/{fileName} (file-get-file-with-name)  
  **Note: This is a breaking change.**

- The type/format of the 'projectId' request parameter has changed from 'string'/'uuid' to 'string' for the following operations:
  - GET /v2/projects/{projectId}/app-installations (app-list-appinstallations)
  - POST /v2/projects/{projectId}/app-installations (app-request-appinstallation)
  - GET /v2/projects/{projectId}/cronjobs (cronjob-list-cronjobs)
  - POST /v2/projects/{projectId}/cronjobs (cronjob-create-cronjob)
  - POST /v2/projects/{projectId}/invites (project-create-project-invite)
  - POST /v2/projects/{projectId}/leave (deprecated-project-leave-project)  
  **Note: This is a breaking change.**
